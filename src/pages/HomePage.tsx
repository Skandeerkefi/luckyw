...
<section className="relative px-4 py-12 overflow-hidden md:px-8 ">
  ...
  <div className="relative mx-auto max-w-7xl">
    ...
    >
      <div className="text-xl font-bold text-white/80 md:text-2xl">🎁 Total GivenAway</div>
      <div className="mt-1 text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-[#E39E2D] to-[#FFFFFF] md:text-6xl">$50000+</div>
    </motion.div>
